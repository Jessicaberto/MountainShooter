...
class Level:
    ...
    def run(self):
        pygame.mixer.music.load('./asset/' + self.name + '.mp3')
    ...
    def level_text(self, text_size, text: str, text_color: tuple, text_pos: tuple):
        text_font = pygame.font.SysFont('Lucida Sans', size=text_size)
